...
const refreshAccessToken = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    return res
      ...
      .cookies("refreshToken", refreshToken, options) //error aa sakta h
      .json(
        new ApiResponse(
          200,
...
const updateUserAvatar = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, user, "Avatar changed successfuly"));
});
...
const updateUserCoverImage = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, user, "Cover image changed successfuly"));
});
    ...
    .json(
      new ApiResponse(
        new ApiResponse(
          200,
          user[0].watchHistory,
          "watch hstroy fetched successfully"
        )
      )
    );
});
